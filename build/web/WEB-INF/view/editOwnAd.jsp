                        ...
                        <ul id="menu">
                            ...
                            <c:if test="${not empty sessionScope.login}">
                                <c:if test="${sessionScope.login != 'admin'}">
                                    <li class="current"><a href="showYourAd"><fmt:message key='showYourAd'/></a></li>
                    ...
                    <div class="sidebar_container">       
                        ...
                        <div id="content">
                            <div class="content_item">
                                <c:if test="${not empty sessionScope.login}">
                                    <h1><fmt:message key='editad'/></h1> 
                                    <form action="editOwnAdPress" method="post">
                                        <table cellspacing="20">
                                            ...
                                            <tr>
                                                <td>
                                                    <textarea name="message" rows="20" cols="70">${ad.descryption}</textarea>                                  
                                                </td>
                                            </tr>
                                        </table>
                                        <p><input type="submit" name="edit" value="Zatwierdz" /></p>
                                    </form>
                                </c:if>	
