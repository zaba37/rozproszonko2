                    ...
                    <div class="sidebar_container">       
                        ...
                        <div id="content">
                            <div class="content_item">
                                <c:if test="${not empty sessionScope.login}">
                                    <h1><fmt:message key='edytujwiad'/></h1> 
                                    <form action="editAdminMsgPress" method="post">
                                        <table cellspacing="20">
                                            ...
                                            <tr>
                                                <td>
                                                    <input type="text" name="title" id="title" value="${msg.title}"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <textarea name="message" rows="20" cols="70">${msg.desctyption}</textarea>                                  
                                                </td>
                                            </tr>
                                        </table>
                                        <p><input type="submit" name="edit" value="<fmt:message key='zatwierdz'/>" /> <input type="submit" name="edit" value="<fmt:message key='usun'/>"/></p>
                                    </form>
                                </c:if>	
