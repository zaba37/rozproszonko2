                    ...
                    <div class="sidebar_container">       
                        ...
                        <div id="content">
                            <div class="content_item">
                                <c:if test="${not empty sessionScope.login}">
                                    <h1><fmt:message key='modadadad'/></h1> 
                                    <form action="modPress" method="post">
                                        ...
                                        <p><input type="submit" name="edit" value="Zatwierdz" /> <input type="submit" name="edit" value="Anuluj" /></p>
                                    </form>
                                </c:if>	
